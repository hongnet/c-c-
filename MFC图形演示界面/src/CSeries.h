...
#import "E:\\ruanjian\\TeeChart Pro v2012 ActiveX Evaluation\\TeeChart2012.ocx" no_namespace
// CSeries 包装器类
...
public:
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xfb, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
